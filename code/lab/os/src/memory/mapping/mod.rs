...
pub use crate::memory::mapping::memory_set::MemorySet;
...
pub fn new_kernel() -> MemoryResult<MemorySet> {
    ...
    let segments = vec![
        Segment {
            ...
            range: Range::<VirtualAddress>::from((text_start as usize)..(rodata_start as usize))
                .into(),
            flags: Flags::VALID | Flags::READABLE | Flags::EXECUTABLE,
        },
        Segment {
            map_type: MapType::Linear,
            range: Range::<VirtualAddress>::from((rodata_start as usize)..(data_start as usize))
                .into(),
